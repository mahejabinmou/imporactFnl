...
const MembershipEvent = () => {
  ...
  return (
    <div
      className="mt-[60px] px-[32px] 2xl:px-[100px] 2xl:mt-[200px]
              ...
              <div className="bg-white px-[25px] py-[17px] rounded-[10px] h-[190px] w-full flex flex-col justify-between">
                ...
                <div className="flex items-center justify-start">
                  ...
                  <div>
                    ...
                    <p className="memberSliderSubtitle">Date : August,17th</p>
                  </div>
                </div>
              ...
              <div className="bg-white px-[25px] py-[17px] rounded-[10px] h-[190px] w-full flex flex-col justify-between">
                ...
                <div className="flex items-center justify-start ">
                  ...
                  <div>
                    ...
                    <p className="memberSliderSubtitle">Date : October,26th</p>
                  </div>
                </div>
                <div className="flex space-x-[15px] pt-[25px] pb-[15px] justify-center items-center">
                  <Link to="/event">
              ...
              <div className="bg-white px-[25px] py-[17px] rounded-[10px] h-[190px] w-full flex flex-col justify-between">
                ...
                <div className="flex items-center justify-start ">
                  ...
                  <div>
                    ...
                    <p className="memberSliderSubtitle">Date : November,14th</p>
                  </div>
                </div>
                <div className="flex space-x-[15px] pt-[25px] pb-[15px] justify-center items-center">
                  <Link to="/event">
              ...
              <div className="bg-white px-[25px] py-[17px] rounded-[10px] h-[190px] w-full flex flex-col justify-between">
                ...
                <div className="flex items-center justify-start">
                  ...
                  <div>
                    ...
                    <p className="memberSliderSubtitle">Date : December,14th</p>
                  </div>
                </div>
                <div className="flex space-x-[15px] pt-[25px] pb-[15px] justify-center items-center">
                  <Link to="/event">
              ...
              <div className="bg-white px-[25px] py-[17px] rounded-[10px] h-[190px] w-full flex flex-col justify-between">
                ...
                <div className="flex items-center justify-start ">
                  ...
                  <div>
                    ...
                    <p className="memberSliderSubtitle">Date : December,28th</p>
                  </div>
                </div>
                <div className="flex space-x-[15px] pt-[25px] pb-[15px] justify-center items-center">
                  <Link to="/event">
